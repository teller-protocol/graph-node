...
fn token_numeric_conversion() {
    ...
    let token_ptr: AscPtr<AscEnum<EthereumValueKind>> =
        module.takes_val_returns_ptr("token_from_i32", num);
    let num_return: i32 = module.takes_ptr_returns_val("token_to_i32", token_ptr);
...
fn big_int_to_from_i32() {
    ...
    let input: i32 = -157;
    let output_ptr: AscPtr<AscBigInt> = module.takes_val_returns_ptr("i32_to_big_int", input);
    ...
    let output: i32 = module.takes_ptr_returns_val("big_int_to_i32", input_ptr);
